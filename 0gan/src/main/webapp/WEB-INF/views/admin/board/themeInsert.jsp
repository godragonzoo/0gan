    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
            <div class="card container-fluid w-75 mb-5">
	            <form action="adminThemeInsert.do" method="post" enctype="multipart/form-data">
	                <div class="col-md-12">
	                    <label class="mt-4">제목</label>
	                    <input type="text" class="form-control-text" name="theme_title">
	                </div>
	                <hr>
	                <label class="col-md-12 mb-3">내용</label>
	                <textarea class="form-control" rows="7" name="theme_content" style="resize: none;"></textarea>
