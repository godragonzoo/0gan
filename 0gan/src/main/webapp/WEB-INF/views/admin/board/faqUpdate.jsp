    ...
    <div class="card-header py-3">
        ...
        <div class="card-body">
            <div class="card container-fluid w-75 mb-5">
	            <form action="adminFaqUpdate.do" method="post" enctype="multipart/form-data" name="form" onsubmit="return valid();">
	            <input type="hidden" name="faq_num" value="${faq.faq_num }">
	                <div class="col-md-12">
	                    <label class="mt-4">제목</label>&nbsp;&nbsp;
	                    <input type="text" class="form-control-text" value="${faq.faq_title }" name="faq_title">
	                </div>
	                <hr>
	                <div class="col-md-12">
	                ...
	                <textarea class="form-control" rows="7" name="faq_content" style="resize: none;">${faq.faq_content }</textarea>
	                <div class="col-md-12 mt-4">
	                    <div class="filebox">
	                        ...
	                        <input type="hidden" value="${faq.faq_file }" name="faq_file">
	                    </div>
	                </div>
	                <hr>
