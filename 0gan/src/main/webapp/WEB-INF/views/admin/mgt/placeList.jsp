...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">공간 정보 관리</h1>


    <!-- DataTales Example -->
    <div class="card shadow mt-4 mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">공간 정보 관리</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <c:forEach var="pList" items="${pList}">
							<tr onclick="window.location='searchDetail.do?place_num=${pList.PLACE_NUM}';">
