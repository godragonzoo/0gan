...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">예약 정보 관리</h1>


    <!-- DataTales Example -->
    <div class="card shadow mt-4 mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">예약 정보 관리</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <c:forEach var="rList" items="${rList}">
							<tr onclick="window.location='userRsvt.do?user_num=${rList.USER_NUM}';">
								<td>${rList.RSVT_NUM}</td>
								<td>${rList.USER_NAME}</td>
								<td>${rList.USER_TEL}</td>
								<td>${rList.USER_EMAIL}</td>
								<td>${rList.RSVT_CHECKIN}</td>
								<td>${rList.RSVT_STATE}</td>
							</tr>
						</c:forEach>
                    </tbody>
                </table>
