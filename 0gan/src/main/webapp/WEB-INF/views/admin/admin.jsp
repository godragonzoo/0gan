...
<div class="row">
    ...
    <script src="../resourcesjs/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="../resourcesvendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../resourcesjs/demo/chart-area-demo.js"></script>
