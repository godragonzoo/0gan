    ...
    <div>
        <div class="card-body">
            <div class="card container-fluid w-75">
                ...
                <hr>
                <div>
                    <label class="col-md-4">작성자</label>
                    <label class="col-md-4">작성일</label>
                    <label class="col-md-3">조회수</label>
                </div>
                <hr>
                <label class="col-md-12 mb-3">내용</label>
                <textarea class="form-control" rows="7" style="resize: none;" readonly></textarea>
                <div class="col-md-12 mt-4">
                    <label for="formFileMultiple" class="form-label">첨부파일</label> Host.png
                </div>
                <hr>
                <div class="d-grid gap-2 d-md-flex mb-3 justify-content-md-end">
                    <button class="btn btn-primary me-md-2 mr-2" type="button">목록</button>
                </div>
            </div>
        </div>
        <hr style="width: 75%;">
