...
<body id="page-top">
    ...
    <div id="collapseBoard" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
...
<div class="card container-fluid w-75 shadow mt-4 mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"> 호스트 문의 </h6>
    </div>
    <div>
        <div class="card-body">
            <div class="card container-fluid w-75">
                <div class="col-md-12">
                    ...
                    <label class="mt-4">제목 ${qVo.host_que_title} </label>
                </div>
                <hr>
                <div>
                    <label class="col-md-4">작성자 ${qVo.host_que_writer}</label>
                    <label class="col-md-4">작성일 ${qVo.host_que_date}</label>
                    <label class="col-md-3">조회수 ${qVo.host_que_view}</label>
                </div>
                <hr>
                ...
                <div class="col-md-12 mt-4">
                    <label for="formFileMultiple" class="form-label">첨부파일&nbsp;${qVo.host_que_file}</label>
                </div>
                <hr>
                <div class="d-grid gap-2 d-md-flex mb-3 justify-content-md-end">
                    <button class="btn btn-primary me-md-2 mr-2" type="button">게시글로 이동</button>
                </div>
            </div>
        </div>
        <hr style="width: 75%;">
	        <div class="card-body">
	            <div class="card container-fluid w-75 mb-5">
	                <div class="row mt-4">
	                    <label class="col-sm-6 ml-2">제목 ${aVo.host_ans_title}</label>
	                    <label class="col-sm-4">작성일 ${aVo.host_ans_date}</label>
	                </div>
	                <hr>
	                <label class="col-md-12 mb-3">내용 </label>
	                <textarea class="form-control mb-3" rows="7" style="resize: none;" readonly>${aVo.host_ans_content}</textarea>
	                <hr class="mt-4">
	                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
	                    <button class="btn btn-primary mb-3 me-md-2" type="button" id="btnSubmit" 
	                    onclick="location.href='hostQnaUpdate.do?host_que_num=${aVo.host_que_num}'">수정</button>
	             	</div>
	         	</div>
	        </div>
    </div>
