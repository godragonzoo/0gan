        ...
        <div class="card-body">
            <div class="card container-fluid w-75">
                <div class="col-md-12">
                    ...
                    <label class="mt-4">제목 ${q.host_que_title} </label>
                </div>
                <hr>
                <div>
                    <label class="col-md-4">작성자 ${q.host_que_writer}</label>
                    <label class="col-md-4">작성일 ${q.host_que_date}</label>
                    <label class="col-md-3">조회수 ${q.host_que_view}</label>
                </div>
                <hr>
                ...
                <div class="col-md-12 mt-4">
                    <label for="formFileMultiple" class="form-label">첨부파일${q.host_que_file}</label>
                </div>
                <hr>
